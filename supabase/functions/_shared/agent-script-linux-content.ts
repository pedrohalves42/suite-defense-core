...
/**
 * CyberShield Agent Linux Script - AUTO-LOADED FROM FILE
 * DO NOT EDIT MANUALLY.
 * Source: _shared/agent-scripts/cybershield-agent-linux-v5.sh
 ...
 * - Service health check in main loop
 *
...
export const AGENT_SCRIPT_LINUX_SH = await Deno.readTextFile(scriptUrl);
