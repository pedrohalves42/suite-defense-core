...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Get all active tenants that have at least 1 agent
    ...
    for (const tenant of (tenants || [])) {
      try {
        // Check if tenant has agents (skip empty tenants)
        ...
        // Call calculate-compliance for this tenant
