 ...
 * 
 * Migrated to serveTenant middleware for standardized auth/CORS/tracing.
 * 
...
serveTenant(async (req, ctx) => {
  ...
  if (!isInternal) {
    ...
    if (authHeader) {
      ...
      userClient = createClient(requireEnv('SUPABASE_URL'), supabaseAnonKey, {
...
`;
  ...
  const insertData: Record<string, any> = {
    tenant_id: tenantId,
    created_by: isInternal ? null : null,
