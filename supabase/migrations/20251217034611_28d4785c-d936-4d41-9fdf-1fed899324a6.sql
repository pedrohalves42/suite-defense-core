...
INSERT INTO public.slo_definitions (name, display_name, description, target_percent, measurement_window, category) VALUES
  ...
  ('api_latency_p99', 'Latência da API (p99)', '99% das requisições respondidas em menos de 2 segundos', 99.00, '1h', 'latency'),
  ('enrollment_success', 'Taxa de Instalação', 'Percentual de enrollment keys usadas com sucesso', 95.00, '7d', 'quality')
