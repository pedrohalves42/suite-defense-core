...
-- FASE 1: Limpar jobs órfãos identificados na auditoria
...
-- FASE 2: Criar função de validação de agent_name antes de INSERT em jobs
...
BEGIN
  ...
  -- Se não encontrou, bloquear INSERT
...
-- FASE 3: Criar índices para performance de queries RLS
