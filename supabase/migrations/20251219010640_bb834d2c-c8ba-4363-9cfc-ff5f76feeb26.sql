-- Adicionar campos de controle de update forçado na tabela agents
...
COMMENT ON COLUMN public.agents.force_update_version IS 'Versão para forçar update (bypassa job system)';
COMMENT ON COLUMN public.agents.force_update_reason IS 'Razão do force update (ex: hotfix_validateSet_break)';
...
-- Índice para encontrar agentes com force_update pendente
