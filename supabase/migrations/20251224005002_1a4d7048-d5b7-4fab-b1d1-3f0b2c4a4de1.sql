-- ============================================================
-- P1: RPC para buscar todas as chaves válidas de um agente (N e N-1)
-- Usada pela verificação de assinatura
-- ============================================================
...
DECLARE
  v_max_version INT;
BEGIN
  -- Buscar versão máxima não-revogada do agente
  ...
  -- Retornar chaves N e N-1 (para suportar rotação)
  RETURN QUERY
  SELECT 
    ask.id as key_id,
    ask.public_key,
