...
-- 1️⃣ PLAYBOOKS: Constraint e Default para execution_mode
...
'assistive: apenas alerta e sugere |
 semi_automatic: executa após aprovação humana (timeout 24h) |
 automatic: somente ações não-destrutivas';

-- 2️⃣ APPROVAL REQUESTS: Token de aprovação via link
...
-- 3️⃣ WEEKLY SECURITY REPORTS: Tabela para relatórios executivos
...
-- 4️⃣ PERFORMANCE INDEXES (usando triggered_at, não created_at)
