-- Fix: Recriar view com SECURITY INVOKER para usar permissoes do usuario que consulta
...
'View SECURITY INVOKER que identifica agentes com problemas de execucao. Usa permissoes do usuario que consulta.';