-- Corrigir ultimos 2 ERRORs criticos de seguranca

-- 1. AGENTS: Remover politica que permite operators/viewers verem hmac_secret
...
SELECT 
  ...
  current_uses,
  used_by_agent,
  -- Mascarar a chave real mostrando apenas os ultimos 4 caracteres
  CASE 
...
-- Adicionar politica para operators verem apenas metadata de enrollment_keys
...
USING (
  ...
  AND false  -- Forcar uso da view enrollment_keys_safe
);
