...
-- Recreate function with correct table reference (user_roles instead of user_tenants)
...
BEGIN
  ...
  -- FIXED: Changed user_tenants to user_roles
  IF NOT EXISTS (
  ...
  SELECT jsonb_build_object(
    ...
    -- User metrics - FIXED: Changed user_tenants to user_roles
