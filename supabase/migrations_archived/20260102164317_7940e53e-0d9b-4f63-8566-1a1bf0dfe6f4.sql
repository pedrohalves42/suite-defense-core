...
-- Dropar diagnose_agent_issues que tem assinatura diferente
DROP FUNCTION IF EXISTS public.diagnose_agent_issues(text, uuid);

-- Recriar diagnose_agent_issues para verificar archived
CREATE FUNCTION public.diagnose_agent_issues(
  p_agent_name text,
  p_tenant_id uuid
)
RETURNS TABLE (
