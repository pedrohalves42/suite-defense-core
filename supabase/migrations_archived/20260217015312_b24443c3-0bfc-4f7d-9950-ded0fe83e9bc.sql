...
BEGIN
  ...
  FROM rls_test_results WHERE tenant_id = p_tenant_id;
  ...
  SELECT jsonb_build_object(
    ...
    -- AI ACTIONS (critical for human_oversight score)
    ...
    -- HUMAN OVERSIGHT (aggregated - directly answers human_oversight dimension)
    ...
    -- TENANT ISOLATION (directly answers cross_tenant_isolation dimension)
    ...
    -- EVIDENCE & AUDIT TRAIL (directly answers evidence_proof dimension)
    ...
    -- DATABASE HARDENING (supports multiple dimensions)
    ...
    -- ENFORCEMENT & COMPLIANCE (directly answers compliance_alignment dimension)
    ...
    -- DLQ & RESILIENCE (directly answers operational_resilience dimension)
    ...
    -- SYSTEM CAPABILITIES (directly answers system_identity dimension)
