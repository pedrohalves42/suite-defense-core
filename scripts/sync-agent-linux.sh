#!/bin/bash
# CyberShield Agent Linux - Script de Sincronizacao
# Sincroniza public/agent-scripts/cybershield-agent-linux-v3.sh -> supabase/functions/_shared/agent-script-linux-content.ts
...
echo "=========================================="
echo "CyberShield Agent Linux - Sync Script"
echo "=========================================="
echo ""
 ...
 * scripts/sync-agent-linux.sh
 * 
 * Fonte: public/agent-scripts/cybershield-agent-linux-v3.sh
 * 
 * Para atualizar:
 * 1. Edite: public/agent-scripts/cybershield-agent-linux-v3.sh
 * 2. Execute: npm run sync:agent:linux
...
/**
 * Retorna o script do agente Linux como string
 */
