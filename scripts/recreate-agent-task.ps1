...
# Validacoes iniciais
Write-Host "=== Validando parametros ===" -ForegroundColor Cyan
...
if (-not (Test-Path $ScriptPath)) {
    Write-Error "Script nao encontrado em: $ScriptPath"
...
try {
    ...
    Write-Host "[WARN]  Aviso ao remover tarefa: $_" -ForegroundColor Yellow
}
...
Write-Host "3. Procure por '[INFO] [OK]  Autenticado com sucesso'"
Write-Host "4. Verifique o dashboard em /admin/agent-health"
Write-Host "`nPara diagnostico detalhado:" -ForegroundColor Yellow
