...
. "$hexRoot\composition\UseCaseWiring.ps1"
...
function Main {
    ...
    try {
        ...
        Initialize-AgentUseCases -Container $script:Agent | Out-Null
        Write-Log "Hexagonal container initialized (Phase 3 use cases wired)" "INFO"
