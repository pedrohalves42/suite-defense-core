...
|---------|-------|-------|------|
| `as any` casts | 1.156 | **~117** | <100 |
| `select('*')` em hooks | 330 | **~42** | <50 ✅ |
...
| Invocações EF/mês | 272.500 | **~26.400** | <30.000 ✅ |
| Código morto removido | — | `Privacy.tsx` duplicada | — |
| Callers migrados p/ dispatcher | 0 | 3 (monitor-thresholds, check-tenant-quotas, monitor-agent-health) | — |
