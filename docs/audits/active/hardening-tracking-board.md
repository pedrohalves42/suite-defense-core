...
| P0-02 | Medium | Defect | Heartbeat offline não detectado | — | Confirmed · **Closed** (2026-07-10) | Agent Lead | ✅ | `evidence/P0-02-heartbeat/before.md` — código 10min / alerta 48h / doc divergente | `evidence/P0-02-heartbeat/after.md` — migration `20260710_heartbeat_alignment.sql`, 13 testes verdes, invariant `assert_heartbeat_thresholds.sql` | `evidence/P0-02-heartbeat/` |
