...
- generic [ref=e3]:
  ...
  - generic [ref=e5]: C:/Users/Pedro/suite-defense-core/src/pages/admin/ComplianceTimeline.tsx:21:18
  - generic [ref=e6]: "36 | import { useTenant } from '@/hooks/useTenant'; 37 | import { toast } from 'sonner'; 38 | import jsPDF from 'jspdf'; | ^ 39 | import autoTable from 'jspdf-autotable'; 40 | const SEVERITY_COLORS = {"
