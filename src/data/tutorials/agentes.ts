...
export const tutorials_agentes: Tutorial[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        tip: "Use ansible-vault para proteger a enrollment_key: ansible-vault encrypt_string 'YOUR_ENROLLMENT_KEY_HERE' --name 'vault_enrollment_key'. Nunca deixe chaves em texto plano nos playbooks.",
      },
      {
