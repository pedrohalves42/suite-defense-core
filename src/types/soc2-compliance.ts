...
export const COMPLIANCE_POLICIES: PolicyDefinition[] = [
  {
    ...
    description: 'Política mestre definindo filosofia e princípios de segurança',
    soc2Criteria: ['CC1', 'CC3'],
    sections: ['Propósito', 'Escopo', 'Princípios de Segurança', 'Responsabilidades', 'Conformidade'],
    filePath: 'docs/policies/01_information_security_policy.md',
  },
  {
    code: 'ACP-001',
    name: 'Política de Controle de Acesso',
    description: 'Controles de autenticação, autorização e gerenciamento de acesso',
    soc2Criteria: ['CC1', 'CC6'],
    sections: ['Autenticação', 'Autorização', 'Acesso Administrativo', 'Ciclo de Vida do Usuário'],
    filePath: 'docs/policies/02_access_control_policy.md',
  },
  {
    code: 'CMP-001',
    name: 'Política de Gestão de Mudanças',
    description: 'Controles para gerenciamento de mudanças em sistemas e código',
    soc2Criteria: ['CC8'],
    sections: ['Tipos de Mudança', 'Controles', 'Procedimentos de Rollback'],
    filePath: 'docs/policies/03_change_management_policy.md',
  },
  {
    code: 'IRP-001',
    name: 'Política de Resposta a Incidentes',
    description: 'Procedimentos para detectar, responder e documentar incidentes',
    soc2Criteria: ['CC7'],
    sections: ['Classificação de Incidentes', 'Processo de Resposta', 'Comunicação'],
    filePath: 'docs/policies/04_incident_response_policy.md',
  },
  {
    code: 'LMP-001',
    name: 'Política de Logs e Monitoramento',
    description: 'Controles de logs de segurança e monitoramento',
    soc2Criteria: ['CC4', 'CC7'],
    sections: ['Logging', 'Proteção', 'Retenção'],
    filePath: 'docs/policies/05_logging_monitoring_policy.md',
  },
  {
    code: 'DRP-001',
    name: 'Política de Classificação e Retenção de Dados',
    description: 'Classificação, proteção e retenção de dados',
    soc2Criteria: ['CC5'],
    sections: ['Classificação de Dados', 'Retenção', 'Exclusão'],
    filePath: 'docs/policies/06_data_retention_policy.md',
  },
  {
    code: 'VRP-001',
    name: 'Política de Gestão de Risco de Fornecedores',
    description: 'Avaliação e gestão de riscos de terceiros',
    soc2Criteria: ['CC9'],
    sections: ['Fornecedores Críticos', 'Avaliação', 'Processo de Revisão'],
    filePath: 'docs/policies/07_vendor_risk_policy.md',
  },
  {
    code: 'BCP-001',
    name: 'Política de Continuidade de Negócios',
    description: 'Controles de disponibilidade e recuperação de desastres',
    soc2Criteria: ['CC7', 'CC9'],
    sections: ['Controles', 'Objetivos de Recuperação', 'Testes'],
  ...
  },
  {
    ...
    sections: ['Controles', 'Revisão de Código', 'Testes'],
