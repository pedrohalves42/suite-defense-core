...
export default function AIInsights() {
  ...
  const pendingInsights = insights.filter(i => !['resolved', 'rejected'].includes((i as never).status || 'open'));
  const acknowledgedInsights = insights.filter(i => ['resolved', 'rejected'].includes((i as never).status || ''));
