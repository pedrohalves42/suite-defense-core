...
export const ACTION_COPY_MAP: Record<string, ActionCopy> = {
  ...
  anomaly: {
    ...
    cta: 'Abrir investigação',
    ctaTooltip: 'Navegar para a página do agente para análise manual detalhada',
    icon: Eye,
  },
  anomaly_detection: {
    ...
    cta: 'Abrir investigação',
    ctaTooltip: 'Navegar para a página do agente para análise detalhada do comportamento anômalo',
    icon: Eye,
