          ...
          <CardContent className="pt-6">
            ...
            <div className={`p-5 rounded-xl mb-6 ${
              ...
              <p className="text-foreground leading-relaxed">
                {((reportPayload as any).executive_summary as Record<string, unknown> | undefined)?.overallMessage as string || (
                  reportPayload.risk_level === 'BAIXO' || reportPayload.risk_level === 'MÍNIMO' ? (
            ...
            <Tabs defaultValue="resumo">
              ...
              <TabsContent value="recomendacoes" className="pt-4">
                <div className="space-y-4">
                  ...
                  {(() => {
                    const execSummary = (reportPayload as any).executive_summary as Record<string, unknown> | undefined;
