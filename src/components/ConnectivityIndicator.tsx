 ...
 * Mostra alertas quando offline ou quando a conexao e restaurada
 */
      ...
      {!isOnline && (
        ...
        >
          <Alert variant="destructive" className="max-w-2xl mx-auto shadow-lg">
            ...
            <AlertTitle>Sem conexao com a internet</AlertTitle>
            <AlertDescription>
      ...
      {showReconnected && isOnline && (
        ...
        >
          <Alert className="max-w-2xl mx-auto shadow-lg border-green-500 bg-green-50 dark:bg-green-950">
            ...
            <AlertTitle className="text-green-800 dark:text-green-200">Conexao restaurada</AlertTitle>
            <AlertDescription className="text-green-700 dark:text-green-300">
              Voce esta online novamente. Todas as funcionalidades foram restauradas.
            </AlertDescription>
          </Alert>
        </motion.div>
      )}
