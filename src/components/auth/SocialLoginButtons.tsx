...
export const SocialLoginButtons = ({ loading, socialLoading, onSocialLogin }: SocialLoginButtonsProps) => {
    ...
    <>
      <div className="relative my-4">
        ...
        <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-[0.2em]">
          <span className="bg-[#1A1D21] px-4 text-white/20">{t('loginPage.orContinueWith')}</span>
        </div>
      </div>
