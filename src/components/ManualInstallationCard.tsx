    ...
    <Alert className="border-2 border-orange-500 bg-orange-50 dark:bg-orange-950/30">
      ...
      <AlertDescription className="space-y-4 mt-3">
        <p className="font-medium text-orange-900 dark:text-orange-100">
          O instalador foi baixado. Para instala-lo, siga estas etapas:
        </p>
        ...
        <div className="bg-white dark:bg-gray-900 p-4 rounded border space-y-2">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 ml-8">
            Va para sua pasta <code className="bg-gray-200 dark:bg-gray-800 px-2 py-1 rounded text-xs">Downloads</code> ou 
        ...
        <div className="bg-white dark:bg-gray-900 p-4 rounded border space-y-2">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 ml-8">
            <strong>Clique com botao direito</strong> no arquivo <code className="font-mono">.exe</code> e selecione
        ...
        <div className="bg-white dark:bg-gray-900 p-4 rounded border space-y-2">
          ...
          <ul className="text-sm text-gray-600 dark:text-gray-400 ml-12 space-y-1 list-disc">
            <li>Criar diretorio <code className="font-mono">C:\CyberShield</code></li>
          ...
          <div className="mt-3 space-y-3 text-sm text-gray-600 dark:text-gray-400 pl-4 border-l-2 border-orange-300">
            <div>
              ...
              <ol className="ml-4 mt-1 space-y-1 list-decimal">
                <li>Clique em "Mais informacoes"</li>
                <li>Clique em "Executar mesmo assim"</li>
                <li>O arquivo e seguro (validado por SHA-256)</li>
              </ol>
            </div>
            
            <div>
              <p className="font-semibold text-gray-800 dark:text-gray-200">Erro de permissoes?</p>
              <p className="ml-4 mt-1">
                Certifique-se de ter clicado com <strong>botao direito</strong> e escolhido "Executar como Administrador".
              </p>
            </div>

            <div>
              <p className="font-semibold text-gray-800 dark:text-gray-200">Instalacao nao funciona?</p>
              <p className="ml-4 mt-1">
