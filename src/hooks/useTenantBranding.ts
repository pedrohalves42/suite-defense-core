  ...
  const query = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data, error } = await supabase
        ...
        .select('id, tenant_id, company_name, company_cnpj, company_email, company_phone, company_website, company_address, logo_url, primary_color, secondary_color, accent_color, report_header_text, report_footer_text, updated_at')
